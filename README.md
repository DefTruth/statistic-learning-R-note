...
## 简介
这是一份非常详细的学习笔记，200页左右，包含了很多详细的公式推导和案例实践，已经整理成pdf，有详细的目录。这份笔记是自己在研究生阶段入门ML的时候写的，总之，从0到1是一个很有趣的过程。由于R和ML是同时接触，所以笔记中附的代码是用`R`写的，基于R语言的`S3`类和`泛型函数`。如果你凑巧发现了这本笔记，并正好在学习机器学习，那么我会【强烈推荐】👏👋你把这份笔记下载下来，结合《统计学习方法》来看，相信一定会让你不虚此行🌟。

## 更新
[2022/01/24] 转眼，就已经过去3年多了，偶尔回来看看自己当初的留下热情，告诉自己要不忘初心。
